...
//===> 0xE008 번지가 0이 아니면 메세지 뿌림.  "Apply status non-zero"
//DELAY 1
#ifdef CONFIG_MACH_LGE_I_BOARD	//BSP_LGE_CAMERA : sy30.park@lge.com 2012-03-29 for skt_VT [start]
...
{0x0990, 0x8300},	// CAM_AWB_K_G_R
{0x098E, 0xC911},	// LOGCAL_ADDRESS_ACCESS			===== 8
{0x0990, 0x7000},	// CAM_AWB_K_B_R
{0x098E, 0xC912},	// LOGICAL_ADDRESS_ACCESS			===== 8
{0x0990, 0x0000},	// CAM_STAT_LUMA_THRESH_LOW
{0x098E, 0xAC0C},	// LOGICAL_ADDRESS_ACCESS [AWB_B_SCENE_RATIO_LOWER] //0x3500,
...
{0x0990, 0x5800},	// CAM_LL_START_SATURATION   // 2011.07.04
{0x098E, 0xC92B},	// LOGICAL_ADDRESS_ACCESS			===== 8
{0x0990, 0x3F00},	// CAM_LL_END_SATURATION //0x80
...
{0x0990, 0x2000},	// CAM_LL_START_AP_GAIN
...
{0x0990, 0x0000},	// CAM_LL_STOP_AP_GAIN
...
{0x0990, 0x1F00},	// CAM_LL_START_NR_THRESH
{0x098E, 0xC938},	// LOGICAL_ADDRESS_ACCESS			===== 8
{0x0990, 0xff00},	// CAM_LL_STOP_NR_RED
{0x098E, 0xC939},	// LOGICAL_ADDRESS_ACCESS			===== 8
{0x0990, 0xff00},	// CAM_LL_STOP_NR_GREEN
{0x098E, 0xC93A},	// LOGICAL_ADDRESS_ACCESS			===== 8
{0x0990, 0xff00},	// CAM_LL_STOP_NR_BLUE
{0x098E, 0xC93B},	// LOGICAL_ADDRESS_ACCESS			===== 8
{0x0990, 0xff00},	// CAM_LL_STOP_NR_THRESH
...
{0xC87C, 0x0005},	// CAM_AET_BLACK_CLIPPING_TARGET //5A
{0x098E, 0xB00C}, 	// LOGICAL_ADDRESS_ACCESS			===== 8
{0x0990, 0x2500},	// BLACKLEVEL_MAX_BLACK_LEVEL //1A00     
...
//0xFFFF, 0x0032,
#endif
#endif	//BSP_LGE_CAMERA : sy30.park@lge.com 2012-03-29 for skt_VT [end]
};
